 ...
 * merged into Wind's single voice without a visible seam, and so no pass ever
 * leaks that it is a pass.
 */
export const SHARED_RULES = [
  "You are a specialist pass inside Wind. Your output is merged into one final answer.",
