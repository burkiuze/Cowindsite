  ...
  return (
    <div className="relative">
      ...
      <section className="relative isolate overflow-hidden">
        <Aurora />
        <div className="mx-auto grid w-full max-w-6xl gap-14 px-6 pt-16 pb-20 lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:gap-10 lg:pt-24">
          <Reveal>
            <p className="eyebrow">An AI work operating system</p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link
                href="/platform"
                className="focus-ring inline-flex items-center gap-2 rounded-full border border-[var(--color-hairline)] px-5 py-3 text-[14px] text-[var(--color-ink-muted)] transition-colors hover:border-[#2b3d4a] hover:text-[var(--color-ink)]"
              >
                See how it works
              </Link>
            </div>

            <ul className="mt-9 flex flex-wrap items-center gap-x-6 gap-y-2 text-[12.5px] text-[var(--color-ink-faint)]">
              {["Parallel by default", "Approval before consequence", "Receipts, not claims"].map((item) => (
                <li key={item} className="flex items-center gap-1.5">
                  <Icon name="check" size={13} className="text-[var(--color-stream-cyan)]" />
                  {item}
                </li>
              ))}
            </ul>
      ...
      <section className="border-y border-[var(--color-hairline)] bg-[var(--color-surface)]/50">
        <div className="mx-auto grid w-full max-w-6xl gap-12 px-6 py-20 lg:grid-cols-[1fr_0.95fr] lg:gap-16">
          <Reveal>
            ...
            <h2 className="display mt-4 max-w-md text-[38px] text-[var(--color-ink)]">
              ...
              <li key={never.title}>
                <Reveal delay={index * 70}>
                  <article className="panel-lift h-full px-5 py-5">
                    ...
                    <h3 className="display mt-4 text-[22px] text-[var(--color-ink)]">{never.title}</h3>
