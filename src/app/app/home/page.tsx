          ...
          <div className="space-y-6">
            ...
            <Panel>
              ...
              <dl className="mt-3.5 space-y-2.5 text-[13px]">
                <Row label="Knowledge sources" value={String(state.knowledge.length)} href="/app/knowledge" />
                <Row label="Connected tools" value={`${connected.length} of ${state.connections.length}`} href="/app/integrations" />
                <Row label="People" value={String(state.members.length)} href="/app/team" />
                <Row label="Flows" value={String(state.workflows.filter((flow) => flow.status === "active").length)} href="/app/flows" />
              </dl>
            </Panel>
          </div>
        </div>
