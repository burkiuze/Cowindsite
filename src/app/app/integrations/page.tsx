      ...
      <section className="mt-9">
        ...
        <ul className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {FIRST_CLASS.map((integration) => {
            ...
            const service = services.find((candidate) => candidate.slug === integration.id);

            return (
              <li key={integration.id}>
                <Panel className="flex h-full flex-col px-4 py-4 transition-colors hover:border-[#2b3d4a]">
